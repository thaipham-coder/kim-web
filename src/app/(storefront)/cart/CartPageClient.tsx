...
export default function CartPageClient() {
   ...
   if (items.length === 0) {
      return (
         <Empty className="bg-white rounded-[2rem] p-12 shadow-sm border border-neutral-100 flex flex-col items-center">
            <EmptyHeader className="flex flex-col items-center">
               <EmptyMedia className="w-24 h-24 bg-neutral-100 rounded-full flex items-center justify-center mb-6">
                  <ShoppingBag className="w-12 h-12 text-neutral-300" />
               </EmptyMedia>
               <EmptyTitle className="text-2xl font-bold text-neutral-900 mb-2">Giỏ hàng trống</EmptyTitle>
               <EmptyDescription className="text-neutral-500 mb-8 max-w-sm">Hãy quay lại menu và chọn những món đồ uống thật ngon cho mình nhé.</EmptyDescription>
            </EmptyHeader>
            <EmptyContent>
